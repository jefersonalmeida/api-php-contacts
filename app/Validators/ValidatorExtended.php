...
{
    private $custom_messages_extended = [
    ...
    public function __construct($translator, $data, $rules, $messages = [], $customAttributes = [])
    {
        ...
        $this->setCustomMessagesExtended();
    }

    protected function setCustomMessagesExtended()
    {
        $this->setCustomMessages($this->custom_messages_extended);
    }
