...
return [
    ...
    */
    ...
    'custom' => [
        'profile.document' => [
            'unique' => 'Cada usuário deve ter um documento de identificação exclusivo.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'siglaUF' => 'UF',
        'proc_city' => 'Procuração Municipal',
        'proc_state' => 'Procuração Estadual',
        'proc_federal' => 'Procuração Federal',
        'isPJ' => 'é PJ?',
        'access_login' => 'Login de acesso',
        'access_password' => 'Senha de acesso',
        'access_document' => 'Documento de acesso',
        'certificate' => 'Certificado digital',
        'state_power' => 'Procuração estadual',
    ],
